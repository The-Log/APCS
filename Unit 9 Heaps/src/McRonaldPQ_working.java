//for use with the HeapPriorityQueue lab.
import java.util.*;
import java.lang.*;

public class McRonaldPQ_working
{
   public static void main(String[] args)
   {
      int MINUTES_OPEN = 1440;
      int SERVICE_AREAS = 3;

      HeapPriorityQueue<Student> heap  = new HeapPriorityQueue<Student>();
      ...
      for(int m=0;m<=MINUTES_OPEN || !heap.isEmpty() || customers[0]!=null || customers[1] !=null || customers[2] != null;m++)
      {
         ...
         if(Math.random()<0.6 && m<MINUTES_OPEN)
         {
